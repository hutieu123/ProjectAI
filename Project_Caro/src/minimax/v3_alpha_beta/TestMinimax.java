	...
	public void Test3x3_7() {
		...
		board.matrix=new int[][] {
			...
			for(int j=0; j<2;j++) {
				...
				node=minimax.initial.getNeighbours().get(3).getNeighbours().get(1).getNeighbours().get(2).getNeighbours().get(j);
				System.out.println(j+":"+node.rowIndexBefore+":"+node.colIndexBefore+":"+node.value);
			...
			for(int j=0; j<1;j++) {
				...
				node=minimax.initial.getNeighbours().get(3).getNeighbours().get(1).getNeighbours().get(2).getNeighbours().get(1).getNeighbours().get(j);
				System.out.println(j+":"+node.rowIndexBefore+":"+node.colIndexBefore+":"+node.value);
				node.board.printMatrix();
